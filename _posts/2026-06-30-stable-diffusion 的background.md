...
### 发展脉络
![发展脉络](/assets/images/posts/sd-timeline.png)
### 从自编码器，Autoencoder（AE）开始
我们不需要给图片打上标签，整个训练过程是自监督的。

![AE结构](/assets/images/posts/ae-structure.png)
...
![过拟合示例](/assets/images/posts/ae-overfitting.png)

### 第一条路线：VAE 和 DDPM
#### VAE
![VAE结构](/assets/images/posts/vae-structure.png)
...
![VAE采样](/assets/images/posts/vae-sampling.png)
...
![VAE生成流程](/assets/images/posts/vae-generation.png)
...
![DDPM加噪](/assets/images/posts/ddpm-noise.png)

既然编码是加噪声，那解码时就应该去掉噪声。DDPM的解码器也不再是一个不可解释的神经网络，而是一个能预测若干个去噪结果的神经网络。

![DDPM去噪](/assets/images/posts/ddpm-denoise.png)
...
![VQ正则化](/assets/images/posts/vq-regularization.png)
